...
<form class="form-horizontal text-center" id="loginForm" action="/login" method="post">
    <div class="login panel panel-primary radius">
        ...
        <@form.text id="name" name="username" label="" labelCss="col-lg-2 control-label" textCss="col-lg-8" componetCss="input-lg" required="required" placeholder="用户名"/>
        <@form.text id="pass" name="password" type="password" label="" labelCss="col-lg-2 control-label" textCss="col-lg-8" componetCss="input-lg" required="required" placeholder="密码"/>
